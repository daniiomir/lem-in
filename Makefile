...
SRC_NAMES = main.c struct.c validation.c validation_2.c error_exit.c map_validation.c tools.c algorithm.c way_parse.c way_lock.c find_cross_ways.c remove_same_edge.c
